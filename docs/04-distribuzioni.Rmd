...
Quello   ci interesseremo in questa lezione è di introdurre le 
...
Per ciascuno, vedremo come calcolare .orange[media] e .orange[varianza],
oltre che qualche esempio concreto.
