...
.left[
_If you believe that witnessing an additional white swan will bring confirmation that there are no black swans, than you should also accept the statement, on purely logical ground, that the sighting of  a red Mini Cooper  should confirm that there are no black swans. [...] "all swans are white" iplies that all nonwhite objects are not swans._
]

.tr[
—Nassim Nicholas Taleb<br>The black swan - "Saw Another Black Mini", p.59<br>
]
]
